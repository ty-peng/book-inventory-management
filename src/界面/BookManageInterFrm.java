...
public class BookManageInterFrm extends JInternalFrame {
	...
	public BookManageInterFrm() {
		...
		button_1.setIcon(new ImageIcon(BookManageInterFrm.class.getResource("/images/Modify_16px_1060983_easyicon.net.png")));
		...
		JLabel label_10 = new JLabel("图书总数：");
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(numberTxt, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE)))
